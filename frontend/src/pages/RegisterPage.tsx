...
export const RegisterPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const msg = err.response?.data?.error?.message || 'Registrasi gagal, coba lagi nanti';
      setErrorMsg(msg);
    } finally {
    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-tr from-slate-100 via-white to-slate-200 p-4 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      <div className="w-full max-w-md">
        ...
        <div className="mb-6 text-center">
          <div className="inline-flex h-10 w-10 items-center justify-center rounded-xl bg-primary text-white shadow-lg">
          ...
          <p className="text-xs text-slate-400 dark:text-slate-500">
            Daftarkan diri Anda sebagai Owner Akun Keuangan Keluarga
          </p>
        </div>
